...
<script>
import VueButtonVue from '../components/VueButton.vue'
...
<style>
    ...
    #coromon-info #info-content #base{
        margin-bottom: 1rem;
    }

    #coromon-info #info-content div#head h3{
        text-align: center;
        margin-bottom: 1rem;
    }
